...
export default class extends React.Component {
  ...
  componentDidMount() {
    if (!this.props.fetchTableData || typeof this.props.fetchTableData !== 'function') {
      throw Error('this.props.fetchTableData must be a function!')
    }
    this.props.fetchTableData(this).then(tableData => {
  ...
  render() {
    ...
    return <div>
      ...
      <div className="filter-area">
        ...
        <Cascader options={configList.map(({key}) => ({ value: key, label: key}))} placeholder="Choose Filters" />
